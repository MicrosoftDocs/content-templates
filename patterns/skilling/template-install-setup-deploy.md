---
title: #Required; page title displayed in search results. Include the word "install," "set up," or "deploy". Include the brand.
...
ms.topic: install-set-up-deploy #Required; leave this attribute/value as-is.
...
This template provides the basic structure of a Install, set up, deploy article pattern. See the
[instructions - Install, set up, deploy](../level4/article-install-setup-deploy.mdd) in the pattern
library.
